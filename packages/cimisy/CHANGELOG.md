...
- 7a73a80: Four GitHub-adapter fixes for correctness and scale:
...
- 3cf9c7a: `cimisy setup github` now registers the `www.`/apex sibling of a custom production domain alongside the domain you type.
